    ...
    <View style={styles.container}>
        <View style={styles.textContainer}>
            <View style={styles.nameContainer}>
                <Text style={{ color: "white", fontSize: 20, fontWeight: "600" }}>{UBIT}</Text>
                <Text style={styles.topic}>{Topic}</Text>
            </View>
            <View style={styles.question}>
                <Text style={{ color: "#bac2de", fontWeight: "semibold" }}>{Question}</Text>
            </View>
        </View>
            ...
            <TouchableWithoutFeedback onPress={() => setModalVisible(false)}>
                ...
                <TouchableWithoutFeedback>
                    <View style={styles.modalContainer}>
                        <Text style={styles.modalText}>Are you sure you want to remove this student from the queue?</Text>
                        <View style={styles.modalButtons}>
                            <Pressable style={styles.modalButtonCancel} onPress={() => setModalVisible(false)}>
                                <Text style={styles.modalButtonTextCancel}>Cancel</Text>
                            </Pressable>
                            <Pressable style={styles.modalButtonRemove} onPress={handleRemove}>
